...
namespace VMDiagrammer.Models
{
    ...
    public class VM_PointMoment : VM_BaseLoad
    {
        ...
        public VM_PointMoment(VM_Beam beam, double d1, double d2, double w1, double w2, ArrowDirections dir) 
            : base(beam, LoadTypes.LOADTYPE_CONC_MOMENT, d1, d2, w1, w2, 3.0)
        {
            if (D1 != D2)
